...
namespace ET
{
    ...
    public sealed class EventSystem : IDisposable
    {
        ...
        private readonly List<Type> allAssembliesTypes = new List<Type>();
        ...
        /// 添加一些Type
        /// </summary>
        public void AddRangeType(List<Type> typeList)
        {
            if (typeList != null)
            {
