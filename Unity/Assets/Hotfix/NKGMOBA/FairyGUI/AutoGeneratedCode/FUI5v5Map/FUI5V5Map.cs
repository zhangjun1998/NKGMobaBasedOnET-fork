...
namespace ETHotfix
{
    ...
    public Btn_GMItem Btn_NoMPCost;
    public GTextField n198;
    public Btn_GMItem Btn_NoHPCost;
    public GTextField n200;
    public Btn_GMItem Btn_NoCDCost;
    public GTextField n201;
    public Btn_GMItem Btn_CreateSpiling;
    ...
    public void Awake(GObject go)
    {
        ...
        {	
    		...
    		SkillTalent_Loader = (GLoader)com.GetChildAt(5);
    		SkillTalent_Bar = SkillSmallProBar.Create(com.GetChildAt(6));
    		SkillTalent_CDInfo = (GTextField)com.GetChildAt(7);
    		SkillTalent = (GGroup)com.GetChildAt(8);
    		SkillQ_Loader = (GLoader)com.GetChildAt(9);
    		SkillQ_Bar = SkillProBar.Create(com.GetChildAt(10));
    		SkillQ_CDInfo = (GTextField)com.GetChildAt(11);
    		SkillQ_Text = (GTextField)com.GetChildAt(12);
    		SkillQ = (GGroup)com.GetChildAt(13);
    		SkillW_Loader = (GLoader)com.GetChildAt(14);
    		SkillW_Bar = SkillProBar.Create(com.GetChildAt(15));
    		SkillW_CDInfo = (GTextField)com.GetChildAt(16);
    		SkillW_Text = (GTextField)com.GetChildAt(17);
    		SkillW = (GGroup)com.GetChildAt(18);
    		SkillE_Loader = (GLoader)com.GetChildAt(19);
    		SkillE_Bar = SkillProBar.Create(com.GetChildAt(20));
    		SkillE_CDInfo = (GTextField)com.GetChildAt(21);
    		SkillE_Text = (GTextField)com.GetChildAt(22);
    		SkillE = (GGroup)com.GetChildAt(23);
    		SkillR_Loader = (GLoader)com.GetChildAt(24);
    		SkillR_Bar = SkillProBar.Create(com.GetChildAt(25));
    		SkillR_CDInfo = (GTextField)com.GetChildAt(26);
    		SkillR_Text = (GTextField)com.GetChildAt(27);
    		SkillR = (GGroup)com.GetChildAt(28);
    		...
    		ExpBar = ProgressBar1.Create(com.GetChildAt(68));
    		HeroLevel = (GTextField)com.GetChildAt(69);
